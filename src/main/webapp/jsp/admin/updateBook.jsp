...
<div class="updateBook">
    ...
    <form action="${pageContext.request.contextPath}/ProccessUpdateServlet?existingImageURL=<%= image_url %>" method="POST" enctype="multipart/form-data">
...
>>>>>>> 0fcd2217d48b663ebe9ed36a1107aca8ea3e7d0e
